...
class Combinations extends Question{
    
    function __construct(){

        $questions = ['icecreams','shirts','chocolate',
                        'numbers','fruit', 'pool','numbersbag','team','lotto','race'];
        ...
        } else if($question == 'pool'){
            $this->poolQuestion();
        } else if($question == 'team'){
            $this->teamQuestion();
        } else if($question == 'lotto'){
            $this->lottoQuestion();
        } else if($question == 'numbersbag'){
            $this->numbersBagQuestion();
    ...
    function lottoQuestion(){

    }

    function numbersBagQuestion(){
