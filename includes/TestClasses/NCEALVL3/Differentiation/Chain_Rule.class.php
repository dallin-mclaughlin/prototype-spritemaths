<?php
    ...
    class ChainRule extends Question{   
        ...
        function poly(){
            ...
            $questionPolyExpression = '('.$polyExpression.')^{'.$power.'}';
            $difExpression = $power.'('.$difExpression.')('.$polyExpression.')^{'.$c.'}';

            //echo $polyExpression;
            //echo $difExpression;

            $this->addToBlurb('\mathrm{Differentiate \ the \ following \ expression}');
            $this->setQuestion($questionPolyExpression);
            $this->setAnswer($difExpression);
        }
