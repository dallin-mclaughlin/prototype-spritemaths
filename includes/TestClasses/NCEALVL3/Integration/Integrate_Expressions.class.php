<?php
    ...
    class IntegrateExpressions extends Question{   
        ...
        function poly(){
            ...
            $this->addToBlurb('\mathrm{Integrate \ the \ following \ equation }');
            $this->setQuestion('y\\prime='.$difExpression);
            $this->setAnswer('y='.$polyExpression.'+C');
        }
