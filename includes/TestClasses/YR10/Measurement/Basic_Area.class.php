<?php
    ...
    class BasicAreaQuestion extends Question{
        ...
        function generateSquareImage($id, $num){
            global $createdByTutor;
            global $questionImageDimensions;
            $imageFile = '';
            $neededRef = '';

            $imageSVG = '<rect x= "150" y = "50" width = "100" height = "100" fill = "white" style="stroke: black; stroke-width: 3;"></rect>';
        ...
        function generateImage($id, $num){
            switch($this->polygonName){
                case 'Square':
                    return $this->generateSquareImage($id, $num);
                    break;
                case 'Rectangle':
